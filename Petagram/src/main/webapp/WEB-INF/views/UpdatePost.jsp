...
<%--  <script>
    ...
    // 세션에 회원 ID를 설정
    sessionStorage.setItem('memberid', '1'); // 임의의 회원 ID인 1으로 설정
    // 세션에서 회원 ID를 가져와서 출력
...
<body>
    ...
    <section id="container">
        <div class="post">
            <form id="editPostForm"  action="/api/post/edit/${postId}" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    ...
                    <div class="box">
                        <input type="file" id="editPostImage" name="imageFile"  value="" accept="image/*">
